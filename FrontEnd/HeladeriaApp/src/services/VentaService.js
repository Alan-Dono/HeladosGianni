...
const VentaService = {
  ...
  anular: async (id) => {
    try {
      ...
      return response.data; // Retorna la respuesta de la anulación
    } catch (error) {
  ...
  obtenerPorId: async (id) => {
    try {
      ...
      return response.data; // Retorna la venta obtenida
    } catch (error) {
  ...
  obtenerPorCierreCaja: async (id) => {
    try {
      ...
      return response.data; // Retorna las ventas obtenidas
    } catch (error) {
      console.error(
